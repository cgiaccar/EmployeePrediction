...
def predict(education, joining_year, city, payment_tier, age, gender, ever_benched, experience):
    leave_or_not = None
    input_values=np.array([education, joining_year, city, payment_tier, age, gender, ever_benched, experience], ndmin=2)
    #input values non è un vettore, ma una matrice con una riga; è una distinzione importante per predict
